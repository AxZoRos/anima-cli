...
from caelestia.utils.wallpaper import extract_all_video_thumbs, get_colours_for_wall, get_wallpaper, set_random, set_wallpaper
...
class Command:
    ...
    def run(self) -> None:
        if getattr(self.args, "extract_thumbs", False):
